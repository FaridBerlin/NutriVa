        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 leading-relaxed mb-6">
              Transform your health journey with personalized nutrition tracking, 
              AI-powered insights, and expert guidance tailored just for you.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/dashboard" className="text-gray-400 hover:text-primary transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 bg-gray-600 group-hover:bg-primary rounded-full transition-colors"></span>
                  Dashboard
                </Link>
              </li>
              <li>
                <Link to="/profile" className="text-gray-400 hover:text-primary transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 bg-gray-600 group-hover:bg-primary rounded-full transition-colors"></span>
                  Profile
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#about" className="text-gray-400 hover:text-primary transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 bg-gray-600 group-hover:bg-primary rounded-full transition-colors"></span>
                  About Us
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="#faq" className="text-gray-400 hover:text-primary transition-colors flex items-center gap-2 group">
                  <span className="w-1.5 h-1.5 bg-gray-600 group-hover:bg-primary rounded-full transition-colors"></span>
                  FAQ
                </a>
              </li>
        ...
        <div className="bg-gradient-to-r from-gray-800/80 to-gray-800/40 rounded-2xl p-8 mb-12 border border-gray-700/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-gray-400">Get nutrition tips and updates delivered to your inbox.</p>
            </div>
            <div className="flex w-full md:w-auto gap-3">
              ...
              />
              <button className="px-6 py-3 bg-gradient-to-r from-primary to-green-400 text-white 
